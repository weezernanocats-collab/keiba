...
export function makeScoredHorse(overrides: Record<string, unknown> = {}) {
  ...
  return {
    ...
    scores: {
      recentForm: 60, distanceAptitude: 55,
      trackConditionAptitude: 50, jockeyAbility: 50, speedRating: 55,
      runningStyle: 50, postPositionBias: 50,
      rotation: 60, lastThreeFurlongs: 55, consistency: 55,
      sireAptitude: 50, trainerAbility: 50,
      seasonalPattern: 50, handicapAdvantage: 50,
      marketOdds: 50, marginCompetitiveness: 50, weatherAptitude: 50,
